// To run with prometheus metrics endpoint
// ballerina build ballerina-prime-echo-alpha.bal #This will generate a jar file
// ballerina run ballerina-prime-echo-alpha.jar --b7a.observability.enabled=true
// or
// ballerina run ballerina-prime-echo-alpha.bal --b7a.observability.enabled=true
